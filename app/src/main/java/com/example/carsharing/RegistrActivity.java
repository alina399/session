        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    String retryPass = retryPassEditText.getText().toString();
                    ...
                    warningDialog = new WarningDialog("Не все поля заполнены!");
                    warningDialog.show(getSupportFragmentManager(), "custom");
                    filling = false;
                } catch (Exception e) {
                    warningDialog = new WarningDialog("Не совпадают пароли!");
                    warningDialog.show(getSupportFragmentManager(), "custom");
                    filling = false;
                }
